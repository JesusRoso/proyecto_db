    ...
    function verAdmin()
    {
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    <a href="#" onclick="verMenu('recicladores_VI/agregar')" class="nav-link">
                    <i class="fas fa-recycle"></i>
                    <p>Reciclador</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" onclick="verMenu('clientes_VI/agregar')" class="nav-link">
                    <i class="fas fa-user-alt"></i>
                    <p>Cliente</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" onclick="verMenu('productos_VI/agregar')" class="nav-link">
        ...
        <div class="card" id="prueba"></div>
        <div class="card" id="productosModal"></div>
        <div class="card" id="clientesModal"></div>
        </div>
        <!-- ./wrapper -->
